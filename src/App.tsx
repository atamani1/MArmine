          ...
          >
            ...
            <header className="relative w-screen h-screen flex flex-col items-center justify-center overflow-hidden">
              ...
              <div className="relative z-20 text-center text-white px-4 max-w-2xl flex flex-col items-center">
                <p className="text-base sm:text-lg font-sans tracking-[0.25em] text-gold-100 uppercase mb-4 font-light">
                  Приглашение на свадьбу
                </p>
                <h1 className="font-serif text-6xl sm:text-8xl tracking-[0.15em] uppercase text-[#fffffa] mb-6 select-none leading-tight drop-shadow-[0_5px_20px_rgba(0,0,0,0.45)]">
                  Мовсес
                  <span className="block italic text-4xl sm:text-5xl text-gold-200 my-2 font-normal lowercase tracking-widest">и</span>
                  Армине
                </h1>
                <div className="w-24 h-[1px] bg-gold-200/60 my-2" />
                <p className="text-xl sm:text-2xl font-serif tracking-[0.2em] italic text-[#fffffa] mt-3 font-light">
                  10 сентября 2026
                </p>
                <p className="text-xs sm:text-sm tracking-[0.15em] font-sans text-stone-200 uppercase mt-1">
                  Четверг, 16:30
                </p>
                <motion.div
                  animate={{ y: [0, 10, 0] }}
                ...
                >
                  <span className="text-[10px] uppercase tracking-widest font-light">Листайте вниз</span>
            ...
            <section id="welcome-section" className="relative py-24 px-6 bg-[#fffffa] overflow-hidden">
              ...
              <div className="max-w-2xl mx-auto text-center relative z-10">
                <div className="flex justify-center mb-6">
                  <div className="w-2 h-2 rounded-full bg-gold-400 mx-1 animate-pulse" />
                  <div className="w-2 h-2 rounded-full bg-gold-500 mx-1" />
                  <div className="w-2 h-2 rounded-full bg-gold-400 mx-1 animate-pulse" />
                </div>
                <span className="text-base font-semibold uppercase tracking-widest text-[#896e4f] block mb-3">
                  Дорогие
                </span>
                ...
                <div className="space-y-6 text-stone-800 font-sans font-light text-lg sm:text-xl leading-relaxed px-4 max-w-lg mx-auto">
                  <p>
                ...
                <div className="mt-10 flex justify-center">
                  <Heart className="w-5 h-5 text-gold-400/80 fill-gold-400/10" />
                </div>
              </div>
            </section>
            ...
            <section className="relative py-28 px-8 sm:px-12 bg-[#fcfbf9] border-y border-gold-200/20 overflow-hidden">
              <div className="max-w-2xl mx-auto relative">
                ...
                <div className="absolute left-[40px] sm:left-[45%] top-24 bottom-12 w-[1px] bg-gradient-to-b from-gold-300 via-gold-200 to-transparent -translate-x-1/2" />
                <div className="space-y-16">
                  ...
                  >
                    <div className="absolute left-0 sm:left-[45%] w-18 h-18 bg-white border border-gold-300 rounded-full flex flex-col items-center justify-center -translate-x-1/2 shadow-sm z-10 w-[72px] h-[72px]">
                      <span className="text-base uppercase font-semibold text-[#896e4f] leading-none">16:30</span>
                      <span className="text-[10px] text-stone-500 font-medium">Сбор</span>
                    </div>
                    <div className="pl-24 sm:pl-0 sm:w-[calc(50%-2.5rem)] sm:pr-12 text-left sm:text-right">
                      <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 font-medium flex items-center gap-2 justify-start sm:justify-end">
                        Сбор гостей
                        <Clock className="w-6 h-6 text-gold-400" />
                      </h4>
                      <p className="text-base sm:text-lg text-stone-700 mt-2 font-light leading-relaxed">
                        Приветственный сбор на веранде ресторана и приятная предпраздничная атмосфера.
                      </p>
                    </div>
                    <div className="sm:w-[calc(50%-2.5rem)]" />
                  </motion.div>
                  ...
                  >
                    <div className="absolute left-0 sm:left-[45%] w-[72px] h-[72px] bg-white border border-gold-300 rounded-full flex flex-col items-center justify-center -translate-x-1/2 shadow-sm z-10">
                      <span className="text-base uppercase font-semibold text-[#896e4f] leading-none">17:30</span>
                      <span className="text-[10px] text-stone-500 font-medium">Венчание</span>
                    </div>
                    <div className="sm:w-[calc(50%-2.5rem)]" />
                    <div className="pl-24 sm:pl-12 sm:w-[calc(50%-2.5rem)] text-left">
                      <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 font-medium flex items-center gap-2">
                  ...
                  >
                    <div className="absolute left-0 sm:left-[45%] w-[72px] h-[72px] bg-white border border-gold-300 rounded-full flex flex-col items-center justify-center -translate-x-1/2 shadow-sm z-10">
                      <span className="text-base uppercase font-semibold text-[#896e4f] leading-none">18:00</span>
                      <span className="text-[10px] text-stone-500 font-medium">Банкет</span>
                    </div>
                    <div className="pl-24 sm:pl-0 sm:w-[calc(50%-2.5rem)] sm:pr-12 text-left sm:text-right">
                      <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 font-medium flex items-center gap-2 justify-start sm:justify-end">
                        Банкет
              ...
              <div className="max-w-3xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6 text-left">
                    <span className="text-base tracking-[0.25em] font-sans font-semibold text-[#896e4f] uppercase block">
                      Где все состоится?
                    </span>
                    ...
                    <div className="flex gap-4 items-start mt-8">
                      <div className="p-3 bg-gold-50 border border-gold-200 text-[#896e4f] rounded-xl flex-shrink-0">
                        <MapPin className="w-6 h-6" />
                      </div>
                      <div>
                        <h4 className="font-serif text-2xl text-stone-800 font-medium">{VENUE_NAME}</h4>
                        <p className="text-lg text-stone-700 font-light mt-1">{VENUE_ADDRESS}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 pt-4">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="px-5 py-2.5 border border-gold-300 text-sm font-medium text-[#896e4f] hover:bg-gold-50 rounded-xl transition-all shadow-sm"
                      >
                        Яндекс Карты 🗺️
                      </a>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="px-5 py-2.5 border border-neutral-200 text-neutral-600 font-medium hover:bg-stone-50 text-sm rounded-xl transition-all"
                      >
                        Google Maps 📍
                      </a>
                    </div>
                  ...
                  <div className="relative group rounded-3xl overflow-hidden shadow-xl border border-gold-100 p-2 bg-white">
                    <div className="relative aspect-square sm:aspect-video md:aspect-square bg-gradient-to-tr from-neutral-200 via-neutral-100 to-neutral-200 rounded-2xl overflow-hidden flex flex-col items-center justify-center p-4">
                      ...
                      <motion.div
                        ...
                        className="relative z-10 w-14 h-14 bg-white rounded-full shadow-lg border border-gold-300 flex items-center justify-center mb-3"
                      >
                        <MapPin className="w-7 h-7 text-red-500 fill-red-100" />
                        <span className="absolute -bottom-1 w-2.5 h-1 bg-black/10 rounded-full blur-[1px]" />
                      </motion.div>
                      <div className="relative z-10 text-center max-w-[220px]">
                        <span className="text-sm uppercase font-sans font-semibold tracking-widest text-[#896e4f] block">
                          Робинзон Крузо
                        </span>
                        <span className="text-xs text-stone-600 block mt-1 font-light">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="absolute inset-x-4 bottom-4 bg-[#896e4f] text-white py-2.5 rounded-xl text-sm font-semibold text-center select-none shadow hover:bg-gold-600 transition-colors uppercase tracking-widest"
                      >
                        Маршрут к ресторану
                      </a>
                    </div>
            ...
            <section className="relative py-28 px-6 bg-[#fffffa]">
            ...
            <section className="relative py-32 px-6 overflow-hidden flex flex-col items-center justify-center min-h-[450px] bg-[#e8e1d9]">
              ...
              <div className="relative z-10 text-center flex flex-col items-center">
                <div className="flex items-center gap-2 justify-center mb-6">
                  ...
                  <Heart className="w-5 h-5 text-tilda-beige fill-[#896e4f]/20 animate-pulse" />
                  <div className="w-8 h-[1px] bg-stone-400" />
                </div>
                <h3 className="font-serif text-4xl sm:text-5xl text-stone-800 italic font-light mb-2">
                  До свадьбы осталось:
                </h3>
                <p className="text-base text-stone-700 uppercase tracking-widest mb-10">
                  Мовсес & Армине // 10 сентября 2026
                </p>
                <CountdownTimer targetDate={WEDDING_DATE} />
                <div className="mt-14 max-w-xs mx-auto text-sm text-stone-500 italic">
            ...
            <footer className="bg-stone-950 text-white/50 text-center py-10 text-sm font-light tracking-widest border-t border-stone-900">
              <p>© МОВСЕС & АРМИНЕ, 2026. ВСЕ ПРАВА ЗАЩИЩЕНЫ</p>
              <p className="text-xs text-stone-700 mt-2 uppercase tracking-wide">
